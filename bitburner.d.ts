 ...
 * @public
 */
declare type CodingContractData = any

/**
 * Corporation related constants
 * @public
 */
declare interface CorpConstants {
...
/** @public */
declare type CorpEmployeePosition =
	| 'Operations'
	| 'Engineer'
	| 'Business'
	| 'Management'
 ...
 *  @public */
declare interface CorpIndustryData {
	startingCost: number
	description: string
 ...
 * @public
 */
declare interface CorpMaterialConstantData {
 ...
 * @public
 */
declare interface IndustryData {
	/** Industry type */
	type: CorpIndustryName
 ...
 * @public
 */
declare interface Infiltration {
	/**
...
/** @public */
declare interface MoneySources {
	sinceInstall: MoneySource
	sinceStart: MoneySource
}

/** @public */
declare interface Multipliers {
...
/** @public */
declare interface Player extends Person {
	money: number
...
/** @public */
declare type PortData = string | number
 ...
 * @public
 */
declare interface ReputationFormulas {
	/**
...
/** @public */
declare type ScriptArg = string | number | boolean
...
/** @public */
declare type SleeveBladeburnerTask = {
	type: 'BLADEBURNER'
...
/** @public */
declare type SleeveCompanyTask = { type: 'COMPANY'; companyName: string }

/** @public */
declare type SleeveCrimeTask = {
	type: 'CRIME'
	crimeType: CrimeType | `${CrimeType}`
}

/** @public */
declare type SleeveFactionTask = {
	type: 'FACTION'
	factionWorkType: FactionWorkType | `${FactionWorkType}`
	factionName: string
}
...
/** @public */
declare type SleeveInfiltrateTask = { type: 'INFILTRATE' }

/** @public */
declare interface SleevePerson extends Person {
...
/** @public */
declare type SleeveRecoveryTask = { type: 'RECOVERY' }

/** @public */
declare type SleeveSupportTask = { type: 'SUPPORT' }

/** @public */
declare type SleeveSynchroTask = { type: 'SYNCHRO' }
 ...
 * @public
 */
declare interface WorkFormulas {
	crimeSuccessChance(
		person: Person,
		crimeType: CrimeType | `${CrimeType}`
	): number
