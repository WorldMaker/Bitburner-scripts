// *** Netscript Definitions file ***
// https://raw.githubusercontent.com/danielyxie/bitburner/dev/src/ScriptEditor/NetscriptDefinitions.d.ts
// Modified s/export/declare for ambient definitions2

/** @public */
declare type ValuesFrom<T> = T[keyof T]
...
/** @public */
declare interface PossibleInfiltrationLocation {
	city: string
	name: string
}
...
/** @public */
declare type NSEnums = typeof enums
/**
